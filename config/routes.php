...
$slim->get('/' . $config['adminPath'] . '/administrators',
    ...
    ->add(new AuthorizationMiddleware($slimContainer, $administratorPermissions[ROUTE_ADMIN_ADMINISTRATORS]))
    ->add(new AuthenticationMiddleware($slimContainer))
...
$slim->get('/' . $config['adminPath'] . '/administrators/reset',
    ...
    ->add(new AuthorizationMiddleware($slimContainer, $administratorPermissions[ROUTE_ADMIN_ADMINISTRATORS_RESET]))
    ->add(new AuthenticationMiddleware($slimContainer))
...
$slim->get('/' . $config['adminPath'] . '/administrators/insert',
    ...
    ->add(new AuthorizationMiddleware($slimContainer, $administratorPermissions[ROUTE_ADMIN_ADMINISTRATORS_INSERT]))
    ->add(new AuthenticationMiddleware($slimContainer))
...
$slim->get('/' . $config['adminPath'] . '/administrators/{primaryKey}',
    ...
    ->add(new AuthorizationMiddleware($slimContainer, $administratorPermissions[ROUTE_ADMIN_ADMINISTRATORS_UPDATE]))
    ->add(new AuthenticationMiddleware($slimContainer))
...
$slim->get('/' . $config['adminPath'] . '/administrators/delete/{primaryKey}',
    ...
    ->add(new AuthorizationMiddleware($slimContainer, $administratorPermissions[ROUTE_ADMIN_ADMINISTRATORS_DELETE]))
    ->add(new AuthenticationMiddleware($slimContainer))
...
$slim->get('/' . $config['adminPath'] . '/roles',
    ...
    ->add(new AuthorizationMiddleware($slimContainer, $administratorPermissions[ROUTE_ADMIN_ROLES]))
    ->add(new AuthenticationMiddleware($slimContainer))
