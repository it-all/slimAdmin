...
use It_All\Slim_Postgres\Infrastructure\Security\Authentication\AuthenticationService;
use It_All\Slim_Postgres\Infrastructure\Security\Authorization\AuthorizationService;
use It_All\Slim_Postgres\Infrastructure\Security\CsrfMiddleware;
use It_All\Slim_Postgres\Infrastructure\System_Events\SystemEventsModel;
use It_All\Slim_Postgres\Infrastructure\Utilities;
use Slim\App;
use Slim\Container;
...
class Initialize
{
    ...
    const PATH_PHP_ERRORS_LOG = APPLICATION_ROOT_DIRECTORY . '/infrastructure/storage/logs/phpErrors.log';
    const PATH_ROUTER_CACHE = APPLICATION_ROOT_DIRECTORY . '/infrastructure/storage/cache/router.txt';
    const SESSION_KEYS = [
    ...
    public function run()
    {
        $slim = new App($this->getSlimSettings());
    ...
    private function removeSlimErrorHandler(Container $slimContainer)
    {
    ...
    private function setSlimMiddleware(App $slim, $slimContainer)
    {
