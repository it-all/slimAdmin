...
namespace It_All\Slim_Postgres\Infrastructure\Security;

use \It_All\Slim_Postgres\Infrastructure\Framework;
use Slim\Http\Request;
use Slim\Http\Response;

class CsrfMiddleware extends Framework\Middleware
{
